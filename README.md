...
- Make sure you have git install on your system. In order to check if you have git installed use ```git --version``` If you do not have git installed follow this link: https://git-scm.com/install/
